...
<ScrollytellingBlock>
    ...
    <Chapter
        ...
        datetime='2021-01-01'
    >
        CO₂ emissions (ODIAC) in New York City
    </Chapter>
    <Chapter
        ...
        datetime='2021-01-01'
    >
        CO₂ emissions (ODIAC) in San Francisco
    </Chapter>
    <Chapter
...
<Figure>
    ...
    datasetId='odiac-ffco2-monthgrid-v2022'
    layerId='co2-emissions'
    dateTime='2000-01-01'  //this is the slider
    compareDateTime='2021-01-01' //this is the slider
    align="center"
    />
    <Caption>
